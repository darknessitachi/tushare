...
public class cons {
	...
	public static List<String> K_MIN_LABELS = Arrays.asList("5", "15", "30","60");
	public static Map<String, String> K_TYPE = new HashMap<String, String>() {
	...
	public static List<String> INDEX_LABELS = Arrays.asList("sh", "sz", "hs300", "sz50", "cyb", "zxb");
	public static Map<String, String> INDEX_LIST = new HashMap<String, String>() {
		private static final long serialVersionUID = 1L;
	...
	public static Map<String, String> P_TYPE = new HashMap<String, String>() {
		private static final long serialVersionUID = 1L;
...
//FORMAT = lambda x: "%.2f" % x
	public static Map<String, String> DOMAINS = new HashMap<String, String>() {
		private static final long serialVersionUID = 1L;
...
public static String ALL_STOCK_BASICS_FILE = String.format("%s%s/static/all.csv", P_TYPE.get("http"), DOMAINS.get("oss"));
public static void main(String[] args) {
	System.out.println(ALL_STOCK_BASICS_FILE);
}
